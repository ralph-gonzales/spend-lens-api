## SPENDLENS
A personalize finance tracking app

### Purpose
- To automate and centralize my current Finance tracker(currently an Excel File).
- To learn modern and best practices in Java, Spring Boot and other Web Application Development tech stack/concepts.
- To have a project in my personal portfolio.
